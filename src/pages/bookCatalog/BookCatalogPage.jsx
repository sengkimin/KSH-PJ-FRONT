...
const BookTable = () => {
  ...
  return (
    <div className='container mx-auto p-4'>
      ...
      <Link to={"/book-create"}>
      <button className="bg-blue-500 text-white px-8 py-3 mb-4 rounded-lg hover:bg-gray-600 cursor-pointer">Create</button>
      </Link>
          ...
          {books.map((book) => (
            <tr key={book.isbn}>
              <td className="px-4 py-6 border-b">
                <Link className="bg-blue-400 text-white px-8 py-2 hover:bg-gray-600 rounded-md" to={`/book/${book.id}`}>
                      View
                </Link>
              </td>
