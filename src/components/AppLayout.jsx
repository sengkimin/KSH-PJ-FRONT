        ...
        >
          ...
          <nav className="mt-4">
            ...
            >
                ...
                src="/program.png"
                alt="Residents"
                className=" w-15 h-16 md:w-18 mr-6"
              />
              Programs
            </Link>
            <Link
            ...
            >
                ...
                src="/assesment.png"
                alt="Residents"
                className="h-16 w-20 mr-10"
              />
              Assessment
            </Link>
            <Link
              to="/reporting"
              className="block  text-xl md:text-2xl font-bold text-[#474747] py-1 md:py-6 px-4 hover:bg-[#207137] hover:text-white  flex items-center"
              onClick={closeSidebar}
            >
                          <img
                src="/report.png"
            ...
            <Link
              to="/medical"
              className="block  text-xl md:text-2xl font-bold text-[#474747] py-2 md:py-6 px-4 hover:bg-[#207137] hover:text-white  flex items-center"
              onClick={closeSidebar}
            >
                      <img
                src="/medicals.png "
